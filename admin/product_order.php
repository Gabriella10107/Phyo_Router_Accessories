<?php
// Include your database connection code from the external file
include('connection.php'); // Adjust the filename as needed
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `order` (firstName, lastName, fullName, phoneNumber, address, email)
            VALUES (?, ?, ?, ?, ?, ?)";

    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssss", $firstName, $lastName, $fullName, $phoneNumber, $address, $email);
...
// Close the database connection (if it was opened during table creation)
$conn->close();
?>
